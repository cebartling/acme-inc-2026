 ...
 * and Hibernate validating both entities against the result *is* the assertion; reaching
 * the test body already means both succeeded. The `count()` calls below simply name each
 * mapped entity, so a newly added entity without a migration is an obvious omission here.
 */
@DataJpaTest
