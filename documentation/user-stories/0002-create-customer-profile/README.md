...
This epic contains user stories derived from the Create Customer Profile user journey. The stories implement the
complete customer onboarding flow, including registration, email verification, profile completion, and consent
management.
