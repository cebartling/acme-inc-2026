...
```
Create an epic user story around identity management
...
Write the content to @documentation/epics/000-identity-management.md.
...
```
Create an epic user story around observability
for the ACME, Inc. e-commerce platform.
Think hard about architecture and design of this cross-cutting concern.
List features that these services will provide. Keep things high-level and avoid
making technology choices here.
Broad acceptance criteria are welcomed, but more detailed acceptance criteria will
be created when this epic user story is decomposed into smaller, focused user
stories.
All diagrams should use Mermaid.js. No ASCII art.
Write the content to @documentation/epics/001-observability-platform.md.
Take into account the architecture patterns and standards documented in
@documentation/ARCHITECTURE.md.
Create a feature branch from the `main` branch for this work.
Commit all changes to this feature branch.
...
```
Create an epic user story around the product catalog
for the ACME, Inc. e-commerce platform.
Think hard about architecture and design of this bounded context service.
List features that this service will provide. Keep things high-level and avoid
making technology choices here.
...
stories.
All diagrams should use Mermaid.js. No ASCII art.
Write the content to @documentation/epics/002-product-catalog.md.
Take into account the architecture patterns and standards documented in
@documentation/ARCHITECTURE.md.
Create a feature branch from the `main` branch for this work.
Commit all changes to this feature branch.
...
```
Create an epic user story around product inventory management
for the ACME, Inc. e-commerce platform.
Think hard about architecture and design of this bounded context service.
List features that this service will provide. Keep things high-level and avoid
making technology choices here.
...
stories.
All diagrams should use Mermaid.js. No ASCII art.
Write the content to @documentation/epics/003-product-inventory.md.
Take into account the architecture patterns and standards documented in
@documentation/ARCHITECTURE.md.
Create a feature branch from the `main` branch for this work.
Commit all changes to this feature branch.
...
```
Create an epic user story around customer management
for the ACME, Inc. e-commerce platform.
Think hard about architecture and design of this bounded context service.
List features that this service will provide. Keep things high-level and avoid
making technology choices here.
...
stories.
All diagrams should use Mermaid.js. No ASCII art.
Write the content to @documentation/epics/004-customer-management.md.
Take into account the architecture patterns and standards documented in
@documentation/ARCHITECTURE.md.
Create a feature branch from the `main` branch for this work.
Commit all changes to this feature branch.
...
```
Create an epic user story around order management
for the ACME, Inc. e-commerce platform.
Think hard about architecture and design of this bounded context service.
List features that this service will provide. Keep things high-level and avoid
making technology choices here.
...
stories.
All diagrams should use Mermaid.js. No ASCII art.
Write the content to @documentation/epics/005-order-management.md.
Take into account the architecture patterns and standards documented in
@documentation/ARCHITECTURE.md.
Create a feature branch from the `main` branch for this work.
Commit all changes to this feature branch.
