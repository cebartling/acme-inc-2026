...
/**
 * The cart side of sign-out (US-0004-08): the signed-in user's cart must not linger in the
 * header badge, and a pending merge notice must not carry over to the next visitor.
 */
